...
public interface ArangoCollection extends ArangoSerializationAccessor {
	 ...
	 * Bulk imports the given values into the collection.
	 *
	 * @param values  vpack that will be stored as documents
	 * @param options Additional options, can be null
	 * @return information about the import
	 * @throws ArangoDBException
	 */
	DocumentImportEntity importDocuments(VPackSlice values, DocumentImportOptions options) throws ArangoDBException;
