...
public interface ArangoDB extends ArangoSerializationAccessor {
	...
	class Builder extends InternalArangoDBBuilder {
		 ...
		 *
		 * @param host address of the proxy host
		 * @param port port of the proxy host 
		 * @return {@link ArangoDB.Builder}
		 */
		 ...
		 * @param host address of the proxy host
		 * @param port port of the proxy host 
		 * @param proxyUser user of the proxy host (may be null)
		 * @param proxyPassword password of the proxy host (may be null)
		 * @return {@link ArangoDB.Builder}
		 */
		public Builder proxy(final String host, final int port, String proxyUser, String proxyPassword) {
			setProxy(host, port, proxyUser, proxyPassword);
			return this;
		}
		 ...
		 * {@link #serializer(ArangoSerialization)}
		 * </p>
		 *
		...
		public synchronized ArangoDB build() {
			...
			int protocolMaxConnections = protocol == Protocol.VST ? ArangoDefaults.MAX_CONNECTIONS_VST_DEFAULT
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/database-database-management.html#create-database">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/database-database-management.html#list-of-databases">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/miscellaneous-functions.html#return-server-version">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#create-user">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#remove-user">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#fetch-user">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#list-available-users">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#modify-user">API
	 *      Documentation</a>
	 */
	 ...
	 * @throws ArangoDBException
	 * @see <a href=
	 *      "https://www.arangodb.com/docs/stable/http/user-management.html#replace-user">API
	 *      Documentation</a>
	 */
